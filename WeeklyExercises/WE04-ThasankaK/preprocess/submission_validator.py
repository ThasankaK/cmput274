...
conf = {
    ...
    "specified_files": ["preprocess/preprocess.py", "preprocess/README", "preprocess/Makefile", "preprocess/submission_validator.py"],
    "assignment_version": "Weekly Exercise 4 (2022)",
}
