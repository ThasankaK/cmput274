...
conf = {
    ...
    "specified_files": ["unfairDice/unfairDice.py", "unfairDice/README", "unfairDice/Makefile", "unfairDice/submission_validator.py"],
    "assignment_version": "Weekly Exercise 2 (2022)",
}
