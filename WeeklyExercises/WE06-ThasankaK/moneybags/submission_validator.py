...
conf = {
    "submission_name": "moneybags",
    "specified_files": ["moneybags/moneybags.py", "moneybags/README", "moneybags/Makefile", "moneybags/submission_validator.py", "moneybags/setup.sh"],
    "assignment_version": "Weekly Exercise 6 (2022)",
}
